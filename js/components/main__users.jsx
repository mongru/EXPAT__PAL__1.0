    ...
    createUser = () => {
        ...
        fetch(userUrl)
            ...
            .then(res => {
                ...
                fire.database().ref('last').push( lastName );
                fire.database().ref('first').push( firstName );
                fire.database().ref('avatars').push( avatar );
                ...
                fetch(geocodeUrl)
                    ...
                    .then(res => {
                        ...
                        fire.database().ref('locations').push( formattedAddress );
                        this.setState({
